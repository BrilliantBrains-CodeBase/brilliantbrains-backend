...
const ctrl = require("../controllers/smtpProvider.controller");
...
router.patch("/:id/default", ...withCsrf, ctrl.setDefault);
router.post("/:id/test-connection", ...withCsrf, ctrl.testConnection);
router.post("/:id/test-email", ...withCsrf, ctrl.sendTestEmail);
